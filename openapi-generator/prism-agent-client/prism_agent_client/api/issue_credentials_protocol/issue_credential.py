...
def sync_detailed(
    ...
    *,
    ...
    """As an issuer, issues the verifiable credential related to the specified record.
     ...
     Sends credential to a holder (holder DID is specified in credential as subjectDid). Credential is
    constructed from the credential records found by credential id.
