...
T = TypeVar("T", bound="PatchContextAction")


@attr.s(auto_attribs=True)
class PatchContextAction:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        patch_context_action = cls(
            contexts=contexts,
        )

        patch_context_action.additional_properties = d
        return patch_context_action
